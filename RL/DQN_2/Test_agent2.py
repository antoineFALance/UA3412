...
PATH_TO_OUTPUT_MODELS = "C:\\Users\\a.lance\\PycharmProjects\\UA3412_\\RL\\DQN_2\\models\\target_net"


env = heater_env2.heaterEnvRC()
state=env.reset()
...
plt.show()
print("Conso energie: "+str(sum(actionList[:index])))
